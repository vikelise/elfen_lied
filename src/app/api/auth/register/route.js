...
import { createSessionToken, createUser, sessionCookie } from "@/lib/auth.server";
...
export async function POST(request) {
  try {
    ...
    if (!user) {
      return NextResponse.json({ error: "Пользователь с таким E-mail уже существует" }, { status: 409 });
    }
